...
<!-- Боковое меню -->	
	...
	<ul class="side_menu" id="menu">
		<li class="firstli"><a href="#" class="active">Тайцзи</a>
			<ul>
				<li>
...
<!-- Содержание -->	
	...
	<div class="content_block">
		<h2>Тайцзи</h2>
		<div class="thaichi_whole">
			<a href="thaichi_history.php">История</a><br>
			<a href="thaichi_media.php">Медиатека</a><br>
			<a href="thaichi_styles.php">Стили тайцзи</a><br>
			<a href="thaichi_schools.php">Школы тайцзи</a><br>
		</div>
	</div>	
		</div>
