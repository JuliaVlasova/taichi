...
<!-- Боковое меню -->	
	...
	<ul class="side_menu" id="menu">
		...
		<ul>
				...
				<li>
					<a href="#" class="active">Виды цигуна</a>
				</li>
			</ul>
...
<!-- Содержание -->	
	<div class="article">
		...
		<div id="wrap">
		<ul id="lineTabs">
			<li><a href="#">Динамический</a></li>
			<li><a href="#">Статический</a></li>
			<li><a href="#">Медитативный</a></li>
			<li><a href="#" class="active">Лечебный</a></li>
		</ul>
		<div id="content">
			<div id="tab1">
			<p>
